...
/*
 * `teacherInputFromValues` faqat FALLBACK sifatida `meta`ni o'qiydi
 * (`values.X ?? meta.X`), zond esa har doim TO'LIQ `values` yuboradi —
 * shuning uchun bo'sh (soxta) `meta` xavfsiz (`TeacherComposer` WP-E
 * shu naqshni ishlatadi, `FAKE_META`).
 */
