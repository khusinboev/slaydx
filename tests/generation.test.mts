...
test("standart hajm narx, dvigatel va formada bir xil", async () => {
  ...
  // AUDIT-19 dan keyin bet chipi bo'lgan vositalarning HAMMASI custom
  // formada (maqola/tezis `ARTICLE_PRICES`/`THESIS_PRICES`, insho
  // `EssayComposer`, kurs ishi/referat/mustaqil ish `WorkComposer` —
  // quyida ALOHIDA qulflanadi); ro'yxat bo'sh bo'lishi mumkin, sikl
  // standart formaga qaytgan vosita uchun saqlanadi.
