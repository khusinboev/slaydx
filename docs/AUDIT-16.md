...
- Agent A (ta'lim turi/daraja/yil, sertifikat yili) — worktree `agent-a84cda4cd5e49cb08`, 2 kommit tayyor, davom etmoqda.
- Agent B (kasblar bazasi ESCO + hh.ru) — worktree `agent-a283d0446b9afc186`, davom etmoqda.
