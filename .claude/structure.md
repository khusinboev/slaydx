...
- Rejalashtirilgan (agentlar): `lib/generation/work/**` (kurs ishi/referat/mustaqil ish: registry/subjects/input/plan/prompts/engine/guard/review/polish/layout/edit), `lib/generation/essay/**` (3 kontekst × turlar, rubric), `research/{googlebooks,lexuz}.ts` + `cite/order.ts` (O'zbekiston tartibi), `work-params.ts`/`essay-params.ts` zondlari, `WorkComposer`/`EssayComposer`, `server/doc-polish.ts`. Jurnal `docs/AUDIT-19.md`.
