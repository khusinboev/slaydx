...
/** Eski importlar uchun: oddiy fallback hujjat */
export function slideAcademicDoc(topic: string, extra: string, author: string, slideCount = 10): AcademicDoc {
  return {
    meta: {
      toolId: "slide",
      workLabel: "Taqdimot",
      ...
      ministry: "oliy",
      kind: "standard",
      pagesLabel: String(slideCount),
      targetPages: slideCount,
