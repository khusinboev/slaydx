...
/*
 * «Suv» iboralar neytral qatlamda (`report/filler.ts`, AUDIT-19 R0-A) —
 * kurs ishi/insho promptlari ham shu ro'yxatni taqiqlaydi. Bu yerda faqat
 * RE-EXPORT: `article/index.ts` va testlar shu yo'ldan import qiladi.
 */
export { FILLER_PHRASES };
